			...
			<div class="row mar-bot40">
				<div class="col-md-offset-3 col-md-6">
					<div class="section-header">
						<h2 class="section-heading animated" data-animation="bounceInUp">Secure
							Transaction</h2>
						<p>Your transaction should be secure :).</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<div class="cform" id="contact-form">
						...
						<%
							if (request.getSession().getAttribute("bmsg") != null) {
						%>
						<%=request.getSession().getAttribute("bmsg")%>
						<%
							}
						%>

						<form:form modelAttribute="transaction" action="/user/transfered"
							method="post" cssClass="contactForm">
							<div class="form-group">
								<label for="email">Enter Your Friend's Account Number</label> <input
									type="number" class="form-control" name="accountNumber"
									id="accountNumber" placeholder="ex.130510" data-rule="email"
									data-msg="Please enter a valid email" />
								<div class="validation"></div>
							</div>
							<div class="form-group">
								<label for="email">Enter Amount</label> <input type="number"
									class="form-control" name="amount" id="amount"
									placeholder="ex.1000" data-rule="email"
									data-msg="Please enter a valid email" />
								<div class="validation"></div>
							</div>

							<button type="submit" class="btn btn-theme pull-left">Transfer</button>
						</form:form>
