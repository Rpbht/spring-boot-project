		...
		<div class="col-sm-4">
			...
			<form:form modelAttribute="user" action="/user/registered" method="post">
				...
				<form:input path="firstName" cssClass="form-control"
					required="required" placeholder="FirstName" type="text" />
				<br>

				<form:input path="lastName" cssClass="form-control"
					required="required" placeholder="LastName" type="text" />
				<br>
				...
				<form:input path="mobileNumber" cssClass="form-control"
					required="required" placeholder="Number" type="number" />
				<br>
				...
				<form:select path="gender" cssClass="input-sm"
